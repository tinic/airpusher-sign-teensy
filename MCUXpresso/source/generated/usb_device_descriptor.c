...
usb_device_endpoint_struct_t g_UsbDeviceInterface0CicVcomSetting0UsbserialcicEndpoints[USB_INTERFACE_0_CIC_VCOM_SETTING_0_USBSERIALCIC_ENDPOINT_COUNT] = {
    {
...
usb_device_interface_struct_t g_UsbDeviceInterface0CicVcomInterface[] = {
    {
        USB_INTERFACE_0_CIC_VCOM_SETTING_0_USBSERIALCIC_INDEX, /* The alternate setting of the interface */
        {
            USB_INTERFACE_0_CIC_VCOM_SETTING_0_USBSERIALCIC_ENDPOINT_COUNT, /* Endpoints count */
            g_UsbDeviceInterface0CicVcomSetting0UsbserialcicEndpoints, /* Endpoints handle */
        },
        NULL,
    },
};

usb_device_endpoint_struct_t g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints[USB_INTERFACE_1_DIC_VCOM_SETTING_0_USBSERIALDIC_ENDPOINT_COUNT] = {
    {
...
usb_device_interface_struct_t g_UsbDeviceInterface1DicVcomInterface[] = {
    {
        USB_INTERFACE_1_DIC_VCOM_SETTING_0_USBSERIALDIC_INDEX, /* The alternate setting of the interface */
        {
            USB_INTERFACE_1_DIC_VCOM_SETTING_0_USBSERIALDIC_ENDPOINT_COUNT, /* Endpoints count */
            g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints, /* Endpoints handle */
        },
        NULL,
    },
};
...
uint8_t g_UsbDeviceDescriptor[] = {
    ...
    0xC0U, 0x16U,                                        /* Vendor ID (assigned by the USB-IF) */
    0x83U, 0x04U,                                        /* Product ID (assigned by the manufacturer) */
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    */
    ...
    USB_INTERFACE_0_CIC_VCOM_SETTING_0_USBSERIALCIC_INDEX,         /* Value used to select this alternate setting
                                        for the interface identified in the prior field */
    USB_INTERFACE_0_CIC_VCOM_SETTING_0_USBSERIALCIC_ENDPOINT_COUNT,  /* Number of endpoints used by this
    ...
    USB_INTERFACE_1_DIC_VCOM_SETTING_0_USBSERIALDIC_INDEX,         /* Value used to select this alternate setting
                                        for the interface identified in the prior field */
    USB_INTERFACE_1_DIC_VCOM_SETTING_0_USBSERIALDIC_ENDPOINT_COUNT,  /* Number of endpoints used by this
                                       interface setting (excluding endpoint zero). */
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
    ...
    if (USB_SPEED_HIGH == speed)
    {
        g_UsbDeviceInterface0CicVcomSetting0UsbserialcicEndpoints[0].maxPacketSize = HS_INTERFACE_0_CIC_VCOM_SETTING_0_EP_1_INTERRUPT_IN_PACKET_SIZE;
        g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints[0].maxPacketSize = HS_INTERFACE_1_DIC_VCOM_SETTING_0_EP_2_BULK_IN_PACKET_SIZE;
        g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints[1].maxPacketSize = HS_INTERFACE_1_DIC_VCOM_SETTING_0_EP_1_BULK_OUT_PACKET_SIZE;
    }
    else
    {
        g_UsbDeviceInterface0CicVcomSetting0UsbserialcicEndpoints[0].maxPacketSize = FS_INTERFACE_0_CIC_VCOM_SETTING_0_EP_1_INTERRUPT_IN_PACKET_SIZE;
        g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints[0].maxPacketSize = FS_INTERFACE_1_DIC_VCOM_SETTING_0_EP_2_BULK_IN_PACKET_SIZE;
        g_UsbDeviceInterface1DicVcomSetting0UsbserialdicEndpoints[1].maxPacketSize = FS_INTERFACE_1_DIC_VCOM_SETTING_0_EP_1_BULK_OUT_PACKET_SIZE;
    }
